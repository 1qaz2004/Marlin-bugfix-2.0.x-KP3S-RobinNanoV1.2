...
#define STRING_CONFIG_H_AUTHOR "(Marlin 2.0.8.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "KP3S Robin Nano V1.2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 170.17
  #define DEFAULT_bedKi 33.16
  #define DEFAULT_bedKd 582.16
...
#define EXTRUDE_MINTEMP 170   //170 Default
...
#define EXTRUDE_MAXLENGTH 200   //200 Default
...
#define MANUAL_PROBE_START_Z 0.0  //Default 0.2
...
/**
 * Choose one of the options below to enable G29 Bed Leveling. The parameters and behavior of G29 will 
 * change depending on your selection.
 *
 *  If using a Probe for Z Homing, enable Z_SAFE_HOMING also!
 *
 * - AUTO_BED_LEVELING_3POINT
 *   Probe 3 arbitrary points on the bed (that aren't collinear). You specify the XY coordinates of all 3 points.
 *   The result is a single tilted plane. Best for a flat bed.
 *
 * - AUTO_BED_LEVELING_LINEAR
 *   Probe several points in a grid.
 *   You specify the rectangle and the density of sample points. The result is a single tilted plane.
 *   Best for a flat bed.
 *
 * - AUTO_BED_LEVELING_BILINEAR
 *   Probe several points in a grid.
 *   You specify the rectangle and the density of sample points. The result is a mesh, best for large or uneven beds.
 *
 * - AUTO_BED_LEVELING_UBL (Unified Bed Leveling)
 *   A comprehensive bed leveling system combining the features and benefits of other systems. UBL also includes 
 *   integrated Mesh Generation, Mesh
 *   Validation and Mesh Editing systems.
 *
 * - MESH_BED_LEVELING
 *   Probe a grid manually. The result is a mesh, suitable for large or uneven beds. (See BILINEAR.)
 *   For machines without a probe, Mesh Bed Leveling provides a method to perform leveling in steps so you can 
 *   manually adjust the Z height at each grid-point.
...
/**
 * Normally G28 leaves leveling disabled on completion. Enable one of these options to restore the prior leveling 
 * state or to always enable leveling immediately after G28.
 */
...
//
// The duration and frequency for the UI feedback sound. Set these to 0 to disable audio feedback in the LCD menus.
//
// Note: Test audio output with the G-Code:  M300 S<frequency Hz> P<duration ms>
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 10 // 2
